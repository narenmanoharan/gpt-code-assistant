...
def create_embeddings_for_chunks(project_id: str, index_id: str, chunks: List[Chunk]):
    ...
    for chunk in tqdm(chunks, desc="Processing Chunks"):
        time.sleep(4) # atmost 15 requests per minute to avoid rate limiting
        index_chunks(project_id, index_id, chunk)
    console.print("Embeddings created and files indexed.")


def index_chunks(project_id: str, index_id: str, chunk: Chunk):
    """Function to index chunks. This happens in two phases:
