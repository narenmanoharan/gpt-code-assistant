...
class TestGetFileTree(unittest.TestCase):
    ...
    def test_get_file_tree_with_max_depth(self):
        ...
        self.assertEqual(
            set(result), set(expected), "get_file_tree did not return the expected files when max_depth is set"
        )
    ...
    def test_get_file_tree_empty_dir(self):
        ...
        self.assertEqual(
            result,
            expected,
            "get_file_tree did not return the expected result for a directory with an empty subdirectory",
        )
